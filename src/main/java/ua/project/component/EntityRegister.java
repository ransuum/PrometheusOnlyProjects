...
import ua.project.model.Client;
import ua.project.model.Pet;
import ua.project.service.ClientServ;
import ua.project.service.PetServ;
...
public class EntityRegister {
    private final ClientServ clientService = new ClientServ();
    private final PetServ petService = new PetServ();
